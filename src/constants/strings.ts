export const Strings = {
  ...
  settings: {
    ...
    yourData: 'Your Data',
    exportReport: 'Export Progress Summary',
    ...
    shareReportTitle: 'Share Progress Summary',
  },
  disclaimer: {
    title: 'Important Health Information',
    body: 'JawEase is a wellness and educational tool. It is not a medical device and does not diagnose, treat, cure, or prevent any disease or condition. The content in this app is for general informational purposes only and is not a substitute for professional medical advice, diagnosis, or treatment. Always consult your doctor, dentist, or other qualified healthcare provider before making any medical decisions or starting a new exercise routine. If you are experiencing a medical emergency, contact your local emergency services immediately.',
    exerciseNotice: 'These are general wellness exercises. Stop if you feel pain and consult a healthcare professional if symptoms persist.',
    sourcesTitle: 'Sources & References',
    sourcesIntro: 'These exercises are based on widely used jaw-relaxation and mobility techniques. The sources below offer further general information.',
  },
  tips: [
